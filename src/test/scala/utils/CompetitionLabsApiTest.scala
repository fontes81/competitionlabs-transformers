...
class CompetitionLabsApiTest extends CompetitionLabsApi {
	...
	/**
		...
		*/
	override def subAccounts: Map[String, CompetitionLabsApi] = ???
	...
	/**
		...
		* @return True on success, false on duplicate and exception if malformed
		*/
	override def pushEventWithDelay(event: BasicEventModel, delay: Long): Boolean = ???
	...
	/**
		...
		* @return True on success, false on duplicate and exception if malformed
		*/
override def pushEventsWithDelay(events: Seq[BasicEventModel], delay: Long): Boolean = ???
	...
	/** *
		...
		* @return
		*/
	override def updateEventAction(action: String, name: Option[String], metaData: Option[Map[String, String]], unitOfMeasureType: Option[String]): Boolean = ???
	...
	/**
	  ...
	  */
	override def getUnitOfMeasure(unitOfMeasureId: String): Option[BasicUnitOfMeasureModel] = ???
	...
	/**
	  ...
	  */
	override def getUoMMultiplierFromKey(unitOfMeasureKey: String): Option[Double] = ???
}
